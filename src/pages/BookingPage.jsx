...
const BookingPage = () => {
  ...
  const fetchProperty = async () => {
    try {
      ...
      const foundProperty = response.properties.find(p => p.id.toString() === propertyId);
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-primary-600 text-white py-3 px-4 rounded-lg hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 flex items-center justify-center"
            >
              {isSubmitting ? (
                <div className="flex items-center">
